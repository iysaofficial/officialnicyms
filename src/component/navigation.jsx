                        ...
                        <div class="col-md-6">
                            <div class="rs-toolbar-left">
                                <div class="welcome-message">
                                    <i class="fa fa-home"></i><span>Selamat Datang di NICYMS</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="rs-toolbar-right">
                                <div class="toolbar-share-icon2">
                                    ...
                                    <li>
                                        <a
                                        href="https://www.facebook.com/people/Iicyms-Iysa/pfbid02kDFtrArHewkZr3br2f5Br6Qjz3w2Q3MgQmpgVx1ptZ3bhioe16SNALPreUbHwQ8gl/"><i
                                            class="fa fa-facebook"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.youtube.com/channel/UC6-Hq4AnYbwiQWz7XemEwKw?reload=9&app=desktop"><i
                                            class="fa fa-youtube"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/company/indonesian-young-scientist-association-iysa/"><i
                                            class="fa fa-linkedin"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/iicyms_official/?hl=en"><i class="fa fa-instagram"></i></a>
                                    </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-12">
                            <div className="logo-area">
                                <a><img src="./assets/logo/nicyms2.png" alt="logo" /></a>
                            </div>
                        </div>
                                ...
                                <div className="flex-grow-1">
                                    ...
                                    <a className="dropdown d-inline-block">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a className="dropdown-item" href="/listnews">Berita</a>
                                            <a className="dropdown-item" href="https://drive.google.com/file/d/19W7ElTUGjFTynbnTWBrbLmNIqJzxbd6D/view" target="_blank">Press Release 2023</a>
                                        </div>
                                    </a>
                                    <a className="dropdown d-inline-block">
                                        <button className="btn btn-secondary dropdown-toggle customNav" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <a className="dropdown d-inline-block">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a className="dropdown-item" href="https://drive.google.com/drive/folders/1gkgBzI83lfkfYHZ6GoH2rtZch8YafQKw" target="_blank">2023</a>
                                            <a className="dropdown-item" href="https://drive.google.com/drive/folders/1tbleqGcl_Fsx1HiT1aM5tLcwgOIAkoO1" target="_blank">2022</a>
                                        </div>
                                    </a>
