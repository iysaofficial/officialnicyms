      ...
      <section className="faq-section">
        <div className="container text-center">
          ...
          <div className="hero-btn text-center">
            <a
              className="btn m-2 "
              href="https://drive.google.com/file/d/1ExS5Q4LRYygYkH1TyTeQMWkTlwZwfJeZ/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              Universitas
            ...
            <a
              className="btn m-2 "
              href="https://drive.google.com/file/d/1JSYu9qRd_XV9W_WK-a8athDpX8j8PSao/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="btn m-2 "
              href="https://drive.google.com/file/d/11EPuxENF4FldZWPrSoJWWGzO4Nhjpu_-/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              Sekolah Dasar (SD)
